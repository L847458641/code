  ...
  $.ajax({
    ...
    success: function success(res) {
      ...
      for (var i = 0; i < categoryLists.length; i++) {
        categoryListes += '<span style=" margin-left: 20px;"><a href="#" style="color:#000" >' + categoryLists[i].category_name + '</a></sapn>';
      }

      ;
      document.getElementById("info_item_1").innerHTML = categoryListes;

      for (var _i = 0; _i < levelList.length; _i++) {
        levelListes += '<span style=" margin-left: 20px;"><a href="#" style="color:#000" >' + levelList[_i].level_name + '</a></sapn>';
      }
